...
import vertx.cpeserver.deviceop.*;
import vertx.cwmp.*;
import vertx.model.*;
import vertx.util.*;
import vertx.util.sxajboss.SxaStagerApiUtils;
...
public class CwmpSession {
    ...
    public Message httpRequestMessage;
    ...
    public CwmpSession(
            ...
            final Message httpRequestMessage,
    ...
    public static class DbQueryHandler implements Handler<JsonObject> {
        ...
        public void handle(JsonObject cpeJsonObject) {
            ...
            if (cpeJsonObject == null) {
                ...
                if (!cpeJsonObject.containsKey(Cpe.DB_FIELD_NAME_CONNREQ_URL)) {
                    ...
                    JsonObject initialProvisioning = cpeJsonObject.getJsonObject(Cpe.DB_FIELD_NAME_INITIAL_PROVISIONING);
