package com.calix.sxa.cc.acs.nbi.devicedata;
...
import com.calix.sxa.cc.connreq.ConnectionRequestUtils;
...
import com.calix.sxa.cc.util.sxajboss.SxaStagerApiUtils;
...
public class DeviceDataService extends AbstractAcNbiCrudService{
    ...
    private class JbossCpeDeleteResultHandler implements Handler<String> {
        ...
        public void handle(String result) {
            if (result == null || VertxUtils.getLocalHostname().startsWith("vmlnx-jqin")) {
