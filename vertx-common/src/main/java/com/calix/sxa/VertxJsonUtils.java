...
public class VertxJsonUtils {
    ...
    public static final SxaVertxException FIELD_TYPE_MISMATCH = new SxaVertxException("Field Type Mismatch!");
    public static final SxaVertxException MISSING_MANDATORY_FIELD = new SxaVertxException("Missing Mandatory Field!");
    public static final SxaVertxException UNKNOWN_FIELD = new SxaVertxException("Unknown Field!");
    ...
    public static void validateFields(
        ...
        if (mandatoryFields != null) {
            for (String mandatoryFieldName : mandatoryFields.keySet()) {
                if (!allFieldNames.contains(mandatoryFieldName)) {
                    ...
                    throw new SxaVertxException("Missing Mandatory Field " + mandatoryFieldName + "!");
                }

                Object value = obj.getField(mandatoryFieldName);
                if (!validateFieldType(value, mandatoryFields.get(mandatoryFieldName))) {
                    throw new SxaVertxException("Field Type Mismatch! Filed name: \"" + mandatoryFieldName
        ...
        if (optionalFields != null) {
            for (String optionalFieldName : optionalFields.keySet()) {
                ...
                if (!validateFieldType(value, optionalFields.get(optionalFieldName))) {
                    throw new SxaVertxException("Field Type Mismatch! Filed name: \"" + optionalFieldName
        ...
        for (String aField : allFieldNames) {
            ...
            throw new SxaVertxException("Unknown Field " + aField + "!");
        }
    }
