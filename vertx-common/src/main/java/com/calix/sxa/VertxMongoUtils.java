...
public class VertxMongoUtils {
    ...
    public static final SxaVertxException INVALID_MONGO_DATE_OBJECT =
            new SxaVertxException("Not a valid Mongo Date Object!");
    ...
    public static void find(
        ...
        if (eventBus == null || collectionName == null || matcher == null || handler == null) {
            throw new SxaVertxException("Null Pointer(s)!");
        }
    ...
    public static class FindHandler implements Handler<Message<JsonObject>> {
         ...
         * @param resultHandler
         */
        public FindHandler(Handler<JsonArray> resultHandler) throws SxaVertxException {
            if (resultHandler == null) {
                throw new SxaVertxException("Null Pointer!");
            }
    ...
    public static class FindOneHandler implements Handler<Message<JsonObject>> {
         ...
         * @param resultHandler
         */
        public FindOneHandler(Handler<JsonObject> resultHandler) throws SxaVertxException {
            if (resultHandler == null) {
                throw new SxaVertxException("Null Pointer!");
            }
    ...
    public static class UpdateHandler implements Handler<AsyncResult<Message<JsonObject>>> {
         ...
         * @param resultHandler
         */
        public UpdateHandler(Handler<Long> resultHandler) throws SxaVertxException {
            if (resultHandler == null) {
                throw new SxaVertxException("Null Pointer!");
            }
    ...
    public static class DeleteHandler implements Handler<Message<JsonObject>> {
         ...
         * @param resultHandler
         */
        public DeleteHandler(Handler<Number> resultHandler) throws SxaVertxException {
            if (resultHandler == null) {
                throw new SxaVertxException("Null Pointer!");
            }
     ...
     * @throws SxaVertxException
     */
    public static Date getDateFromMongoDateObject(JsonObject mongoDateObject) throws SxaVertxException{
        if (mongoDateObject == null || !mongoDateObject.containsField(MOD_MONGO_DATE)) {
            log.error("getDateFromMongoDateObject(): Null Pointer!");
            throw SxaVertxException.NULL_POINTER;
        }
